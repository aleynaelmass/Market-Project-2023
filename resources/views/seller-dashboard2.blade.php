              ...
              <div class="offcanvas-body p-0">
                <nav class="navbar-dark">
                  <ul class="navbar-nav">
                    ...
                    <li>
                      <a href="./satıcı-bilgileri.html" class="nav-link px-3 active">
                    ...
                    <li>
                      ...
                      <div class="collapse" id="layouts">
                        <ul class="navbar-nav ps-3">
                          <li>
                            <a href="./urunler.html" class="nav-link px-3">
                              <span class="me-2"
                          ...
                          <li>
                            <a href="./satis-islemleri.html" class="nav-link px-3">
                              <span class="me-2"
                                ><i class="bi bi-speedometer2"></i
                              ></span>
                              <span>Satış</span>
                          ...
                          <li>
                            <a href="./fiyat-analiz.html" class="nav-link px-3">
                              <span class="me-2"
                                ><i class="bi bi-speedometer2"></i
                              ></span>
                          ...
                          <li>
                            <a href="./stok-islemleri.html" class="nav-link px-3">
                              <span class="me-2"
                                ><i class="bi bi-speedometer2"></i
                              ></span>
                ...
                <div class="row">
                  <div class="col-md-3 mb-3">
                    <div class="card bg-primary text-white h-100">
                      <div class="card-body py-5"> <a href="../ttez/urunler.html" class="btn btn-primary">Ürün Güncellemesi için tıklayınız.</a></div>
                      
                    </div>
                  </div>
                  <div class="col-md-3 mb-3">
                    <div class="card bg-warning text-white h-100">
                      <div class="card-body py-5"><a href="./satis-islemleri.html" class="btn btn-warning text-white">Satış İşlemi gerçekleştirmek için tıklayınız.</a></div>
                     
                    </div>
                  </div>
                  <div class="col-md-3 mb-3">
                    <div class="card bg-success text-white h-100">
                      <div class="card-body py-5"><a href="./fiyat-analiz.html" class="btn btn-success text-white">Ürün piyasa fiyat analizi görmek için tıklayınız.</a></div>
                     
                    </div>
                  </div>
                  <div class="col-md-3 mb-3">
                    <div class="card bg-danger text-white h-100">
                      <div class="card-body py-5"><a href="./stok-islemleri.html" class="btn btn-danger text-white">Stok durumunu incelemek için tıklayınız.</a></div>
